...
% Use dir to find all data files in the outputs directory
    ...
    if ~isempty(match)
       ...
       % Construct the meta_data file name dynamically
        ...
        for probe_number = 1:num_probes
            ...
            attenuation_filename = sprintf('./outputs/attenuation_data_%s_pressure_%g_freq_%g.txt', friction_status, dimensionless_p_list(p), driving_frequency);
